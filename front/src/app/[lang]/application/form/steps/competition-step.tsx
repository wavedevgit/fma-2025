  ...
  return (
    ...
    >
      ...
      <p className="mt-1 text-sm leading-6 text-gray-600">
        Fournissez des informations à propos de vos participations passées et
        vos motivations.
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-4 justify-between">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="space-y-3">
              <FormLabel>
                Avez-vous déjà participé à des compétitions (Olympiades,
                concours nationaux...) <RequiredAsterisk />
              </FormLabel>
              <FormControl>
                <RadioGroup
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                Si oui, veuillez spécifier lesquelles et le résultat obtenu.
              </FormLabel>
              <FormControl>
                <Textarea
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="space-y-3">
              <FormLabel>
                Avez-vous participé à FMA in Mai 2024 ? <RequiredAsterisk />
              </FormLabel>
              <FormControl>
                <RadioGroup
                  onValueChange={field.onChange}
      ...
      <div className="mt-10 grid grid-cols-1 gap-4 justify-between">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                Parlez-nous de vos motivations à participer à cette compétition{" "}
                <RequiredAsterisk />
              </FormLabel>
              <FormControl>
                <Textarea
