...
import ScrollDown from "@/components/shared/icons/scroll-down";
import { MeteorCard } from "@/components/home/meteor-card";
...
export default async function Home({
  ...
  return (
    <>
      <div className="w-full max-w-3xl px-5 xl:px-0 space-y-2 mb-24">
        <HeroSection heroTitle={t('hero-title')} heroSubtitle={t('hero-subtitle')}/>
        <TimeAndLocation />
        <CtaButton />
      </div>
